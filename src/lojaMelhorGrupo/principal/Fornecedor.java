...
public class Fornecedor extends Pessoa implements Geral {
    ...
    private int quebraLoopFornecedor;
   ...
   private List<Fornecedor> fornecedores = new ArrayList<>();
    ...
    public void cadastrar() {
        ...
        do {
            ...
            Fornecedor criaFornecedor = new Fornecedor(id, nomePessoal, cnpj, logradouro, bairro, cidade, estado, cep, cpf, rg, telefone, email, dataNascimento, getDataFormatada());
            fornecedores.add(criaFornecedor);
